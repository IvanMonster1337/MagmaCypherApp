...
console.log(strEncodeUTF8(str));
let result = magmaCypher.encrypt(strEncodeUTF8(str));
console.log(result);
console.log(result.blocks[0].bef);
console.log(result.blocks[0].aft);
let res = String.fromCharCode.apply(null, new Uint8Array(result.result));
console.log(res);
let decrResult = magmaCypher.decrypt(result.result);
console.log(decrResult);
console.log(decrResult.blocks[0].bef);
console.log(decrResult.blocks[0].aft);
console.log(String.fromCharCode.apply(null, new Uint8Array(decrResult.result)));
